		...
		<div class="right_box">
			...
			<div class="one_con">
				<form action="" method="post" id="make4_form">
					<table>
						<tr class="resume_edu">
							<td class="one_con_left">修改教育经历</td>
							<td></td>
						</tr>
						<tr>
							<td class="one_con_left"><strong>*</strong>开始日期：</td>
							<td>
								<input type="text" readonly="readonly" id="starttime" name="starttime" value="<?php echo date('Y-m-d',$data['starttime'])?>" class="w150"/>
							</td>
						</tr>
						<tr>
							<td class="one_con_left"><strong>*</strong>结束日期：</td>
							<td>
								<input type="text" readonly="readonly" id="endtime" name="endtime" value="<?php echo date('Y-m-d',$data['endtime'])?>" class="w150"/>
							</td>
						</tr>
						<tr>
							<td class="one_con_left"><strong>*</strong>学校名称：</td>
							<td>
								<input type="text" name="schoolname" id="" value="<?php echo $data['schoolname'];?>">
							</td>
						</tr>
						<tr>
							<td class="one_con_left"><strong>*</strong>专业名称：</td>
							<td>
								<input type="text" name="skillname" id="" value="<?php echo $data['skillname'];?>">
							</td>
						</tr>
						<tr>
							...
							<td>
								<select name="edu" class="select_box">
									...
									<option value="1" <?php if($data['edu'] == '初中'){?> selected="selected" <?php }?>>初中</option>
									<option value="2" <?php if($data['edu'] == '高中'){?> selected="selected" <?php }?>>高中</option>
									<option value="3" <?php if($data['edu'] == '中技'){?> selected="selected" <?php }?>>中技</option>
									<option value="4" <?php if($data['edu'] == '中专'){?> selected="selected" <?php }?>>中专</option>
									<option value="5" <?php if($data['edu'] == '大专'){?> selected="selected" <?php }?>>大专</option>
									<option value="6" <?php if($data['edu'] == '本科'){?> selected="selected" <?php }?>>本科</option>
									<option value="7" <?php if($data['edu'] == '硕士'){?> selected="selected" <?php }?>>硕士</option>
									<option value="8" <?php if($data['edu'] == '博士'){?> selected="selected" <?php }?>>博士</option>
									<option value="9" <?php if($data['edu'] == '博后'){?> selected="selected" <?php }?>>博后</option>
								</select>
							</td>
						</tr>
					</table>
					...
					<a href="" class="make1_submit make_back">跳过这一步</a>
					<?php }?>
					<a href="" class="make1_submit make_back">返回上一步</a>
					<input type="hidden" name="reid" value="<?php echo $_GET['reid'];?>">
					<input type="hidden" name="reid4" value="<?php echo $_GET['reid4'];?>">
				</form>
			</div>
			<!-- 简历填写内容结束 -->
