				...
				<form action="" method="post" id="make2_form">
					<table class="pos_table">
						<tr>
							...
							<td><input maxlength="50" value="<?php echo $data['workplace'];?>" name="workplace">&nbsp;</td>
						</tr>
						<tr>
							<td class="one_con_left"><strong>*</strong>期望岗位性质：</td>
							<td>
								<input type="radio" name="quality" class="resume_radio" <?php if($data['quality'] == '全职'){?>checked="checked"<?php }?> value="1" >&nbsp;全职
								<input type="radio" name="quality" class="resume_radio" value="2"<?php if($data['quality'] == '兼职'){?>checked="checked"<?php }?>>&nbsp;兼职
								<input type="radio" name="quality" class="resume_radio" value="3"<?php if($data['quality'] == '实习'){?>checked="checked"<?php }?>>&nbsp;实习
							</td>
						</tr>
						<tr>
						...
						<tr>
							...
							<td>
								<select name="salary" class="select_box">
									<option value="0">请选择</option>
									<option value="1" <?php if($data['salary'] == '面议'){?> selected="selected"<?php }?>>面议</option>
									<option value="2" <?php if($data['salary'] == '1000-1500元/月'){?> selected="selected"<?php }?>>1000-1500元/月</option>
									<option value="3" <?php if($data['salary'] == '1000-1500元/月'){?> selected="selected"<?php }?>>1000-1500元/月</option>
									<option value="4" <?php if($data['salary'] == '2000-3000元/月'){?> selected="selected"<?php }?>>2000-3000元/月</option>
									<option value="5" <?php if($data['salary'] == '3000-5000元/月'){?> selected="selected"<?php }?>>3000-5000元/月</option>
									<option value="6" <?php if($data['salary'] == '5000-10000元/月'){?> selected="selected"<?php }?>>5000-10000元/月</option>
									<option value="7" <?php if($data['salary'] == '1万以上/月'){?> selected="selected"<?php }?>>1万以上/月</option>
								</select>
							</td>
						</tr>
						<tr class="pos_tr">
							...
							<td class="cate_change">
								...
								<?php if(is_array($pos)):?><?php  foreach($pos as $v){ ?>
									...
									<?php if(is_array($v['son'])):?><?php  foreach($v['son'] as $v1){ ?>
										<p>
											<input type="checkbox" name="posid[]" value="<?php echo $v1['posid'];?>" class="posid_change" <?php if(in_array($v1['posid'],$posid)){?> checked="checked"<?php }?>><?php echo $v1['posname'];?>
										</p>
										<?php }?><?php endif;?>
									</h2>
