	...
	<!-- 左边盒子 -->	
       ...
       <!-- 如果为1证明是个人用户 -->
		...
		<div class="right_box">
			...
			<div class="one_box">
				<span class="one">修改工作经历</span>
				<span class="two">(带<strong>*</strong>的为必填)</span>
			</div>
			<!-- 简历填写内容开始 -->
			<div class="one_con">
				<form action="" method="post" id="make5_form">
					<table>
						<tr class="resume_edu">
							<td class="one_con_left">修改工作经历</td>
							<td class="one_no_thing"></td>
						</tr>
						<tr>
							<td class="one_con_left"><strong>*</strong>开始日期：</td>
							<td>
								<input type="text" readonly="readonly" id="starttime" name="starttime" value="<?php echo $data['starttime'];?>" class="w150"/>
							</td>
						</tr>
						<tr>
							<td class="one_con_left"><strong>*</strong>结束日期：</td>
							<td>
								<input type="text" readonly="readonly" id="endtime" name="endtime" value="<?php echo $data['endtime'];?>" class="w150"/>
							</td>
						</tr>
						<tr>
							<td class="one_con_left"><strong>*</strong>企业名称：</td>
							<td>
								<input type="text" name="companyname" id="" value="<?php echo $data['companyname'];?>">
							</td>
						</tr>
						<tr>
							<td class="one_con_left">企业介绍：</td>
							<td>
								<textarea name="companyinfo" class="resume_textarea"><?php echo $data['companyinfo'];?></textarea>
							</td>
						</tr>
						<tr>
							<td></td>
							<td>请简要说明公司性质、规模、业务、发展历程等</td>
						</tr>
						<tr>
							<td class="one_con_left"><strong>*</strong>职务名称：</td>
							<td>
								<input type="text" name="job" id="" value="<?php echo $data['job'];?>">
							</td>
						</tr>

						<tr>
							<td class="one_con_left">业绩或表现：</td>
							<td>
								<textarea name="outstanding" class="resume_textarea"> <?php echo $data['job'];?></textarea>
							</td>
						</tr>
						<tr>
							<td></td>
							<td>请简要介绍您的个人业绩，工作情况。</td>
						</tr>
					</table>

					<input type="submit" value="保存并增加" class="make1_submit">
					<input type="hidden" name="reid" value="<?php echo $_GET['reid'];?>">
					<input type="hidden" name="reid5" value="<?php echo $_GET['reid5'];?>">
				</form>
			</div>
			<!-- 简历填写内容结束 -->
			...
			<div class="state_box">
				<ul>
					...
					<li class="one">
						<div class="progress">
							<div style="width:80%;background-color:#99CC00; height:8px;left:0;top0;position:absolute"> </div>
						</div>
						80%
					</li>
					<li class="one two">
