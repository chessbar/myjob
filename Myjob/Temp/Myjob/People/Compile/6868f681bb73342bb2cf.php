	...
	<!-- 左边盒子 -->	
       ...
       <!-- 如果为1证明是个人用户 -->
		...
		<div class="right_box">
			...
			<!-- 简历填写内容开始 -->
			<div class="one_con">
				<form action="<?php echo U('make3');?>" method="post" id="make3_form">
					<table>
						<tr>
							<td class="one_con_left"><strong>*</strong>技能特长：</td>
							<td>
								<textarea name="skill" id="" class="resume_textarea"></textarea>
							</td>
						</tr>
						<tr>
							<td></td>
							<td>
								<span id="hd_skill"></span>
							</td>
						</tr>
					</table>

					<input type="submit" value="保存并跳到下一步" class="make1_submit">
					<a href="<?php echo U('make2_update', array('reid'=>(int)$_GET['reid']));?>" class="make1_submit make_back">返回上一步</a>
