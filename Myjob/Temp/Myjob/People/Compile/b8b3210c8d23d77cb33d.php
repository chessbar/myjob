	...
	<!-- 左边盒子 -->	
       ...
       <!-- 如果为1证明是个人用户 -->
		...
		<div class="right_box">
			...
			<div class="one_box">
				<span class="one">修改培训经历</span>
				<span class="two">(带<strong>*</strong>的为必填)</span>
			</div>
			<!-- 简历填写内容开始 -->
			<div class="one_con">
				<form action="<?php echo U('make6_update');?>" method="post" id="make6_form">
					<table>
						<tr>
						...
						<tr>
							<td class="one_con_left"><strong>*</strong>培训机构：</td>
							<td>
								<input type="text" name="organ" id="" value="<?php echo $data['organ'];?>">
							</td>
						</tr>
						<tr>
							<td class="one_con_left"><strong>*</strong>培训课程：</td>
							<td>
								<input type="text" name="classname" id="" value="<?php echo $data['classname'];?>">
							</td>
						</tr>
						<tr>
							<td class="one_con_left">培训描述：</td>
							<td>
								<textarea name="description" class="resume_textarea" name="description"><?php echo $data['description'];?></textarea>
							</td>
						</tr>
						<tr>
							<td></td>
							<td> 例如培训内容、结业情况、获得证书、学习收获等。 </td>
						</tr>
						
					</table>

					<input type="submit" value="修改" class="make1_submit">
					<a href="" class="make1_submit make_back">返回上一步</a>
					<input type="hidden" name="reid" value="<?php echo $_GET['reid'];?>">
					<input type="hidden" name="reid6" value="<?php echo $_GET['reid6'];?>">
				</form>
			</div>
			<!-- 简历填写内容结束 -->
