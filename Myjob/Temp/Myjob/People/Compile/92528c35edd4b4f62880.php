			...
			<div class="one_con">
				...
				<table>
						<tr>
							...
							<td><input maxlength="80" value="<?php echo $data['resumename'];?>" name="resumename">&nbsp;</td>
						</tr>
						<tr>
						...
						<tr>
							...
							<td><input maxlength="10" value="<?php echo $data['realname'];?>" name="realname"></td>
						</tr>
						<tr>
							<td class="one_con_left">性别：</td>
							<td>
								<input type="radio" <?php if($data['sex'] == '男'){?>checked="checked"<?php }?> name="sex" class="resume_radio" value="1">男
								<input type="radio" name="sex" <?php if($data['sex'] == '女'){?>checked="checked"<?php }?> class="resume_radio" value="2">女
							</td>
						</tr>
						<tr>
							<td class="one_con_left"><strong>*</strong>年龄：</td>
							<td><input maxlength="6" value="<?php echo $data['age'];?>" name="age">&nbsp;</td>
						</tr>
						<tr>
							<td class="one_con_left">身高：</td>
							<td><input maxlength="6" name="height" value="<?php echo $data['height'];?>">&nbsp;</td>
						</tr>
						<tr>
							<td class="one_con_left">婚姻状况：</td>
							<td>
								<input type="radio" <?php if($data['marrystate'] == '未婚'){?>checked="checked"<?php }?> name="marrystate" class="resume_radio" value="1">未婚
								<input type="radio" <?php if($data['marrystate'] == '已婚'){?>checked="checked"<?php }?> name="marrystate" class="resume_radio" value="2">已婚
								<input type="radio" <?php if($data['marrystate'] == '保密'){?>checked="checked"<?php }?> name="marrystate" class="resume_radio" value="3">保密
							</td>
						</tr>
						<tr>
							...
							<td>
								<select name="workyear" class="select_box">
									...
									<option  <?php if($data['workyear'] == '无经验'){?>selected="selected"<?php }?> value="1">无经验</option>
									<option <?php if($data['workyear'] == '1年以下'){?>selected="selected"<?php }?> value="2">1年以下</option>
									<option <?php if($data['workyear'] == '1-3年'){?>selected="selected"<?php }?> value="3">1-3年</option>
									<option <?php if($data['workyear'] == '3-5年'){?>selected="selected"<?php }?> value="4">3-5年</option>
									<option <?php if($data['workyear'] == '5-10年'){?>selected="selected"<?php }?> value="5">5-10年</option>
									<option <?php if($data['workyear'] == '10年以上'){?>selected="selected"<?php }?> value="6">10年以上</option>
								</select>
							</td>
						</tr>
						<tr>
							...
							<td>
								<input type="text" name="household" id="" value="<?php echo $data['household'];?>"/>
							</td>
						</tr>
						<tr>
							...
							<td>
								<select name="edu" class="select_box">
									...
									<option <?php if($data['edu'] == '初中'){?>selected="selected"<?php }?>value="1">初中</option>
									<option <?php if($data['edu'] == '高中'){?>selected="selected"<?php }?>value="2">高中</option>
									<option <?php if($data['edur'] == '中技'){?>selected="selected"<?php }?>value="3">中技</option>
									<option <?php if($data['edu'] == '中专'){?>selected="selected"<?php }?>value="4">中专</option>
									<option <?php if($data['edu'] == '大专'){?>selected="selected"<?php }?>value="5">大专</option>
									<option <?php if($data['edu'] == '本科'){?>selected="selected"<?php }?>value="6">本科</option>
									<option <?php if($data['edu'] == '硕士'){?>selected="selected"<?php }?>value="7">硕士</option>
									<option <?php if($data['edu'] == '博士'){?>selected="selected"<?php }?>value="8">博士</option>
									<option <?php if($data['edu'] == '博后'){?>selected="selected"<?php }?>value="9">博后</option>
								</select>
							</td>
						</tr>
						<tr>
							<td class="one_con_left"><strong>*</strong>手机号码：</td>
							<td><input maxlength="60" value="<?php echo $data['phonenumber'];?>" name="phonenumber">&nbsp;</td>
						</tr>
						<tr>
							<td class="one_con_left"><strong>*</strong>电子邮箱：</td>
							<td>
								<input maxlength="60" value="<?php echo $data['mail'];?>" name="mail">
							</td>
						</tr>
						<tr>
							<td class="one_con_left"><strong>*</strong>通讯地址：</td>
							<td>
								<input maxlength="150" value="<?php echo $data['address'];?>" name="address">
							</td>
						</tr>
						<tr>
							<td class="one_con_left">联系 Q Q：</td>
							<td><input maxlength="15" value="<?php echo $data['qq'];?>" name="qq"></td>
						</tr>
						<tr>
							<td class="one_con_left">个人主页/博客：</td>
							<td><input maxlength="50" value="<?php echo $data['homepage'];?>" name="homepage"></td>
						</tr>
					</table>
