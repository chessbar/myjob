...
<link rel="stylesheet" type="text/css" href="http://localhost/myjob/./Myjob/Myjob/People/Tpl/Public/Css/company-index-index.css">
	<jquery/>
	<script type="text/javascript" src="http://localhost/myjob/./Myjob/Myjob/People/Tpl/Public/Js/backTop.js"></script>
</head>
<body>
	<!-- 最顶部灰色条开始 -->
