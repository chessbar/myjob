		...
		<div class="right_box">
			...
			<?php if(!empty($data)){?>
				<table class="resume_center">
					...
					<tr>
						<td class=""><?php echo $v['starttime'];?>&nbsp到&nbsp<?php echo $v['endtime'];?></td>
							<td><?php echo $v['companyname'];?></td>
							<td><?php echo $v['job'];?></td>
							<td>
								<a href="<?php echo U('Resume/make5_update',array('reid'=>$_GET['reid'],'reid5'=>$v['rid5']));?>">编辑</a>
								|
								<a href="<?php echo U('Resume/make5_del',array('reid'=>$_GET['reid'],'reid5'=>$v['rid5']));?>">删除</a>
							</td>
					</tr>
					<?php }?><?php endif;?>
				</table>
			...
			<div class="one_con">
				<form action="" method="post" id="make5_form">
					<table>
						<tr class="resume_edu">
							<td class="one_con_left">填加工作经历</td>
							<td class="one_no_thing"> &nbsp&nbsp(无工作经验者请跳过这一步 )</td>
						</tr>
						<tr>
						...
						<tr>
							...
							<td>
								<textarea name="companyinfo" class="resume_textarea"></textarea>
							</td>
						</tr>
						<tr>
							<td></td>
						...
						<tr>
							...
							<td>
								<textarea name="outstanding" class="resume_textarea"></textarea>
							</td>
						</tr>
						<tr>
							<td></td>
					...
					<a href="<?php echo U('Resume/make6',array('reid'=>$_GET['reid']));?>" class="make1_submit make_back">跳过这一步</a>
					<a href="<?php echo U('Resume/make4',array('reid'=>$_GET['reid']));?>" class="make1_submit make_back">返回上一步</a>
					<input type="hidden" name="reid" value="<?php echo $_GET['reid'];?>">
					<input type="hidden" name="reid5" value="<?php echo $_GET['reid'];?>">
				</form>
			</div>
			<!-- 简历填写内容结束 -->
