...
<link rel="stylesheet" type="text/css" href="http://localhost/myjob/./Myjob/Myjob/Member/Tpl/Public/Css/password.css">
</head>
<body>
			...
			<form action="" method="post">
				<table>
					...
					<tr>
						...
						<td><input type="password" maxlength="20" name="pwd2"></td>
					</tr>
					<tr>
						<td></td>
						<td class="sub"><input type="submit" value="确定修改"></td>
					</tr>
				</table>
			</form>
		</div>
