...
<body>
			...
			<!-- 左边盒子 -->
				...
				<div class="head_top_l">
					<span class="top_login">
						欢迎    
						<a href="" class="name" style="color:#339900">admin</a>
					   登录！    
					   <a href="" style="color:#0066CC">[会员中心]</a>
					   <a href="" style="color:#0066CC">[退出]</a>
					</span>
				</div>
				<!-- 未登录 -->
				<!-- <div class="head_top_l">
	...
	<!-- 头部开始 -->
	<div class="head">
		<a href="" class="logo"><img src="http://localhost/myjob/./Myjob/Myjob/Member/Tpl/Public/images/logo_front.png" alt="" /></a>
	</div>
	<!-- 头部结束 -->
	...
	<div class="reg-box">
		<div class="box-bar">
			...
			<p>切换至<a href="">个人会员</a>注册</p>
			<!-- <p>切换至<a href="">企业会员</a>注册</p> -->
		</div>
		<form action="" class="reg-form" method="POST">
			<label for="">用户名：<input type="text" name="username" id="" /></label>
			<label for="">常用电子邮箱：<input type="text" name="usermail" id="" /></label>
			<label for="">设置登录密码：<input type="password" name="password" id="" /></label>
			<label for="">确认登录密码：<input type="password" name="passwordc" id="" /></label>
			<label for="">
