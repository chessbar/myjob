...
<link rel="stylesheet" type="text/css" href="http://localhost/myjob/./Myjob/Myjob/Member/Tpl/Public/Css/head-pic.css">
</head>
<body>
...
<?php if(!defined("HDPHP_PATH"))exit;C("SHOW_NOTICE",FALSE);?>
	...
	<a href="<?php echo U('Member/Account/pwd');?>" <?php if(METHOD == 'pwd'){?> class="select"<?php }?>>密码修改</a>
			...
			<form action="" method="post" enctype="multipart/form-data">
				<div class="pic_box">
					<p class="curtext">当前头像</p>
					<div class="big_pic">
					<?php if($face){?>
					<img src="http://localhost/myjob/<?php echo $face;?>" alt="">
					<?php  }else{ ?>
					<img src="http://localhost/myjob/./Myjob/Myjob/Member/Tpl/Public/Images/no_photo.gif" alt="">
					<?php }?>
						
						<!-- <img src="" alt=""> -->
					</div>
					<p class="big_size">100×100</p>
					<div class="sma_pic">
						<?php if($face){?>
					<img src="http://localhost/myjob/<?php echo $face;?>" alt="">
					<?php  }else{ ?>
					...
					<p class="sma_size">48×48</p>
					<p class="up_text">上传头像</p>
					<div class="upform">
						<input type="file" class="avatars" name="upload">
						<p class="pic_form">允许格式：jpg/gif/bmp/png</p>
