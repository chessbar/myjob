			...
			<form action="" method="post">
				<table>
					...
					<tr>
						<td class="name">性别：</td>
						<td>
							<label><input class="rad" type="radio" <?php if($data['sex'] == '男'){?>checked="checked" <?php }?>name="sex" value="1">男</label>
							<label><input class="rad" type="radio" <?php if($data['sex'] == '女'){?>checked="checked" <?php }?> name="sex" value="2">女</label>
						</td>
					</tr>
					<tr>
						<td class="name">生日：</td>
						<td>
							<input type="text" id="birthday" name="birthday" readonly="readonly" value="<?php echo $data['birthday'];?>"/> 
						</td>
					</tr>
					<tr>
						<td class="name">
					...
					<tr>
						...
						<td><input type="text" name="msn" value="<?php echo $data['msn'];?>"></td>
					</tr>
					<tr>
						<td class="name">个人简介：</td>
						<td><textarea class="u_textarea" name="intro"><?php echo $data['intro'];?></textarea></td>
					</tr>
					<tr>
						<td></td>
