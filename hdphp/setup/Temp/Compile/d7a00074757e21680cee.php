...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>        
        ...
        <link href='http://localhost/myjob/hdphp/setup/./Tpl/State/Css/setup.css' rel='stylesheet' type='text/css'/>
...
<body>
    <div class="hd_setup">
        ...
        <h2>
            <a href="http://localhost/myjob/hdphp/setup/index.php?c=Rbac" class="home">返回安装首页</a>
